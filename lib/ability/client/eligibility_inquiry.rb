# Class for requesting eligibility based on a given set of details
class Ability::Client::EligibilityInquiry

  include Ability::Helpers::XmlHelpers
  include Ability::Helpers::EligibilityHelpers

  ELIGIBILITY_ENDPOINT = "https://access.abilitynetwork.com/portal/seapi/services/DDEEligibilityInquiry"
  ...
  # Submit the eligibility request, returning eligibility results
  def submit
    ...
    doc = @client.parse_xml(@client.post("#{ELIGIBILITY_ENDPOINT}/#{@service_id}", xml.target!))
