...
class Ability::Client::ClaimStatusInquiry
  
  CLAIM_STATUS_ENDPOINT = "https://access.abilitynetwork.com/portal/seapi/services/PPTNClaimStatusInquiry"
  ...
  def submit
    ...
    doc = @client.parse_xml(@client.post("#{CLAIM_STATUS_ENDPOINT}/#{@service_id}", xml.target!))
